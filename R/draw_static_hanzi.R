...
#' @export
draw_static_hanzi <- function(hanzi, width, align, background_color) {
  ...
  return(cat(as.character(paste0("<", align, "><img src = 'https://raw.githubusercontent.com/skishore/makemeahanzi/master/svgs-still/", utf8ToInt(hanzi), "-still.svg' style = 'width:", width, "; background-color:", background_color, "; border-radius: 8%'></", align, ">"))))
}
